...
# train_dataset = KTRDataset(root_dir='./sentences/',
#                            df=train_df,
#                            processor=processor,
#                            max_target_length=max_length)
# eval_dataset = KTRDataset(root_dir='./sentences/',
#                            df=test_df,
#                            processor=processor,
#                           max_target_length=max_length)
...
class HandWrittenDataset(Dataset):
    def __init__(self, root_dir, processor,train=True, max_target_length=128, test_split=0.2):
        self.root_dir = root_dir
        self.processor = processor
...
# train_dataset = KTRDataset(root_dir='./kurdish-handwritten-words/',
#                            train=True,
#                            processor=processor,
#                            max_target_length=max_length)
# eval_dataset = KTRDataset(root_dir='./kurdish-handwritten-words/',
#                            train=False,
#                            processor=processor,
#                           max_target_length=max_length)